...
<body>
    <div class="ms-auto">
        <div class="row">
            <div class="col">
                <h1><a href="dashboard.php" class="text-dark left: 0"><i class="fa-solid fa-house"></i></a></h1>
            </div>
            <div class="col text-center">
               <h1><a href="../views/profile.php" class="text-secondary text-decoration-none">Welcome, <?= $_SESSION['username'] ?></a></h1>
            </div>
            <div class="col text-end">
                <h1><a href="../views/logout.php" class="text-danger right: 0"><i class="fa-solid fa-user-xmark"></i></a></h1>
            </div>
        </div>
            ...
            <div class="card w-75 mx-auto border-0">
                <div class="card-header bg-white border-0">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <i class="fa-solid fa-plus fa-3x text-info" data-bs-toggle="modal" data-bs-target="#add-product"></i>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody class="lead">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete-product.php?id=<?= $product['id'] ?>" class="btn btn-danger">
                                        <i class="fa-solid fa-trash"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="payment.php?id=<?= $product['id'] ?>" class="btn btn-success">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-5">
                        ...
                        <form action="../actions/product-actions.php" method="post" class="w-75 mx-auto pt-4 p-5">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <button type="submit" class="btn btn-info w-100" name="register">Add</button>
                                </div>
                            </div>
                        </form>
                    </div>
